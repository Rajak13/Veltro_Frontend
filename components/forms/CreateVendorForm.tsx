...
export default function CreateVendorForm({ onSuccess }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <Input label="Vendor Name" icon={Building2} {...register("name")} error={errors.name?.message} />
      <Input label="Contact Person" icon={User} {...register("contactPerson")} error={errors.contactPerson?.message} />
