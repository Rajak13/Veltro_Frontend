...
export default function CustomerDetailView({
  ...
  const { data: history, isLoading: loadingHistory } = useCustomerHistory(customerId);
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card padding="md" className="lg:col-span-2">
          <VehiclesSection customer={customer} />
        </Card>

        <Card padding="md" className="lg:col-span-3">
          <PurchasesSection history={history} loadingHistory={loadingHistory} />
        </Card>

        <Card padding="md" className="lg:col-span-3">
          <AppointmentsSection history={history} loadingHistory={loadingHistory} />
        </Card>
      </div>
    </div>
  );
...
function PurchasesSection({
  ...
  history: ReturnType<typeof useCustomerHistory>["data"];
