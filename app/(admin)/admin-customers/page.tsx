...
// Admin Customers Page - View and manage all customers
// Uses the same API endpoints as staff: GET /api/staff/customers, POST /api/staff/customers
  ...
  return (
    <div>
      <PageHeader
        ...
        breadcrumb={[{ label: "Admin" }, { label: "Customers" }]}
        action={
